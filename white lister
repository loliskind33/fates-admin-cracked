...
WL = game:HttpGet("https://raw.githubusercontent.com/davidkra230/fates-admin-cracked/master/%2557%2548%2549%2554%2545%254c%2549%2553%2554")
...
if Check(SubData) then
 Starter:SetCore("SendNotification", { Title = "Whitelisted!", Text = "No need to run this anymore.", Duration = 10, })
else
 Starter:SetCore("SendNotification", { Title = "Copied to clipboard!", Text = "Send your whitelist to cool69 or fate.", Duration = 10, })
 setclipboard(SHA256(SubData))
end
